...
public class EmployeeService {
    ...
    public ArrayList getAllEmployees()
    {
        ArrayList empList = new ArrayList();
         String sql = "SELECT  id,firstName,lastName,phone,gender,age,departmentName,roleName,salary,specialAllowance,carAllowance FROM employees LEFT JOIN roles On employees.roleId= roles.roleId LEFT JOIN departments On employees.departmentId= departments.departmentId";
        try {
     ...
     public Boolean AddEmployeeData(Employee emp) {
        ...
        try {
            Connection con = JDBCConnectionManager.getConnection();
            String sql = "INSERT INTO employees(firstName,lastName,phone,gender,age,departmentId,roleId,salary,specialAllowance,carAllowance)"
                    + "VALUES(? ,? ,? ,? , ? , ?, ?, ?, ?, ?)";
     ...
     public ArrayList showSearchEmployeeList(Employee emp1) {
        ...
        try {
            Connection con = JDBCConnectionManager.getConnection();
            String sql = "SELECT  id,firstName,lastName,phone,gender,age,departmentName,roleName,salary,specialAllowance,carAllowance FROM employees LEFT JOIN roles On employees.roleId= roles.roleId LEFT JOIN departments On employees.departmentId= departments.departmentId where firstName like ? \n"
      ...
      public  Employee getEmployee(String employeeId) {
        ...
        try {
            ...
            String sql = "select * from employees e, departments d, roles r " + "where e.departmentId=d.departmentId and e.roleId=r.roleId and e.id=?";
            PreparedStatement preparedStatement = con.prepareStatement(sql);
